...
async function startnaimi() {
    const naimi = naimiConnect({
        ...
        browser: ['Siesta Multi Device','Safari','1.0.0'],
        auth: state,
...
██║░╚██╗██║░░██║██║░░██║╚██████╔╝░░░██║░░░██║░░██║
╚═╝░░╚═╝╚═╝░░╚═╝╚═╝░░╚═╝░╚═════╝░░░░╚═╝░░░╚═╝░░╚═╝`, 'red'))
console.log(color('[SIESTA MD]', 'cyan'), color('OWNER SEDANG ONLINE SEKARANG!', 'yellow'))

	console.log(color('[SIESTA MD]', 'cyan'), color('SELAMAT DATANG OWNER ><', 'yellow'))
...
mediaType:2,
thumbnail: ppusernya,
sourceUrl: `https://www.instagram.com/Kemii`,
