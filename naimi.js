...
const isOwner = setting.ownerNumber == m.sender ? true : ["6288980870067@s.whatsapp.net"].includes(m.sender) ? true : false
...
mediaType:1,
mediaUrl: 'https://www.instagram.com/Kemii',
sourceUrl: "https://www.instagram.com/Kemii"}}}, { quoted: m })
}
try {
...
naimi.sendListMsg(m.chat, `Hallo ${pushname} ${ucapanWaktu}\nPilih salah satu menu di bawah`,`*© SIESTA MD*`, `*LIST MENU SIESTA MD*`, `Click Here`, sections, m)
///////MENU
break
case 'cerpenmenu':
if (!isRegister) return reply(blomdaftar) & sendButMessage (sender, daftar1, daftar2, daftar3, { quoted: m}) 
...
naimi.sendMessage(m.chat, { image: { url: anu }, caption: `*© Powered by Siesta*\n\nJangan lupa donet :)` }, { quoted: m })
 }
break
case '3dbox':
  if (!isPremium) return sendButMessage (from, prem1, prem2, prem3, { quoted:ftex})
...
maker.textpro("https://textpro.me/3d-box-text-effect-online-880.html", [
    `${q}`,])
.then((data) => naimi.sendMessage(m.chat, { image: { url: data }, caption: `*© Powered by Siesta*\n\nJangan lupa donet :)` }, { quoted: m }))
...
if (!isRegister) return reply(blomdaftar) & sendButMessage (sender, daftar1, daftar2, daftar3, { quoted: m}) 
    if (isBan) return reply(mess.banned)
if (!args[0]) return reply(`Mana link nya?\nContoh :\n${prefix}${command} https://github.com/XyzenzKannaV1/tes`)
